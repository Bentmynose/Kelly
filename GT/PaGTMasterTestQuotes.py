...
version to test adding quotes to search term 
version currently fails to process search terms greater than 30 words (google limit) - waiting for kelly to resolve
...
# this is control file containing the google sign on info used 
